<template>
    <div>
        ...
        <wxc-minibar title="组织架构"
                     background-color="white"
                     text-color="black"></wxc-minibar>
        <scroller class="scroller">
            <wxc-cell v-for="n in 7"
                      :has-arrow="true"
                      class="name"
                ...
                <image class="image"
                       slot="label"
                       src="bmlocal://assets/organize.png"></image>
                <text slot="title">子公司{{n}}</text>
            </wxc-cell>
        </scroller>
    ...
    export default {
        ...
        computed: {
            contentStyle: function () {
                ...
                return {
                    height: tabPageHeight - 90 - eros.statusBarHeight,
                }
            },
